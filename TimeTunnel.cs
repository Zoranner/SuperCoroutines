...
namespace KimoTech.DigitalFactory.Kernels
{
    public class TimeTunnel : MonoBehaviour
    {
        ...
        {
            get { return Instance.currentCoroutine; }
        }
        ...
        private readonly Dictionary<int, HashSet<CoroutineHandle>> _layeredProcesses =
            new Dictionary<int, HashSet<CoroutineHandle>>();
        ...
        private static TimeTunnel[] ActiveInstances = new TimeTunnel[16];
                                ...
                                Profiler.BeginSample(ProfilerDebugAmount == DebugInfoType.SeperateTags ?
                                                         ("Processing Coroutine (Slow Update), " +
                                                          ...
                                                          (_processTags.ContainsKey(_indexToHandle[coindex]) ?
                                                              ...
                                                              ", no tag")) : "Processing Coroutine (Slow Update)");
                            }
                                     ...
                                     float.IsNaN(SlowUpdateProcesses[coindex.i].Current))
                            {
                                if (ReplacementFunction != null)
                                {
                                    SlowUpdateProcesses[coindex.i] =
                                        ReplacementFunction(SlowUpdateProcesses[coindex.i], _indexToHandle[coindex]);
                            ...
                            if (ProfilerDebugAmount != DebugInfoType.None && _indexToHandle.ContainsKey(coindex))
                            {
                                Profiler.BeginSample(ProfilerDebugAmount == DebugInfoType.SeperateTags ?
                                                         ("Processing Coroutine (Realtime Update), " +
                                                          ...
                                                          (_processTags.ContainsKey(_indexToHandle[coindex]) ?
                                                              ", tag " + _processTags[_indexToHandle[coindex]] :
                                                              ", no tag")) : "Processing Coroutine (Realtime Update)");
                            }
                                     ...
                                     float.IsNaN(UpdateProcesses[coindex.i].Current))
                            {
                                if (ReplacementFunction != null)
                                {
                                    UpdateProcesses[coindex.i] =
                                        ReplacementFunction(UpdateProcesses[coindex.i], _indexToHandle[coindex]);
                                    ReplacementFunction = null;
                                }
                                     ...
                                     float.IsNaN(LateUpdateProcesses[coindex.i].Current))
                            {
                                if (ReplacementFunction != null)
                                {
                                    LateUpdateProcesses[coindex.i] =
                                        ReplacementFunction(LateUpdateProcesses[coindex.i], _indexToHandle[coindex]);
                                    ReplacementFunction = null;
                                }
                            ...
                            if (ProfilerDebugAmount != DebugInfoType.None && _indexToHandle.ContainsKey(coindex))
                            {
                                Profiler.BeginSample(ProfilerDebugAmount == DebugInfoType.SeperateTags ?
                                                         ("Processing Coroutine (Manual Timeframe), " +
                                                          ...
                                                          (_processTags.ContainsKey(_indexToHandle[coindex]) ?
                                                              ", tag " + _processTags[_indexToHandle[coindex]] :
                                                              ", no tag")) : "Processing Coroutine (Manual Timeframe)");
                            }
                    ...
                    try
                    {
                            ...
                            !(localTime < EndOfFrameProcesses[coindex.i].Current))
                        {
                                     ...
                                     float.IsNaN(EndOfFrameProcesses[coindex.i].Current))
                            {
                                if (ReplacementFunction != null)
                                {
                                    EndOfFrameProcesses[coindex.i] =
                                        ReplacementFunction(EndOfFrameProcesses[coindex.i], _indexToHandle[coindex]);
                                    ReplacementFunction = null;
                                }
        ...
        public static CoroutineHandle RunCoroutine(IEnumerator<float> coroutine)
        {
            return coroutine == null ? new CoroutineHandle() :
                Instance.RunCoroutineInternal(coroutine, Segment.Update, null, null,
        ...
        {
            return coroutine == null ? new CoroutineHandle() :
                Instance.RunCoroutineInternal(coroutine, Segment.Update, layer, null,
                                              new CoroutineHandle(Instance._instanceID), true);
        }
        ...
        {
            return coroutine == null ? new CoroutineHandle() :
                Instance.RunCoroutineInternal(coroutine, Segment.Update, null, tag,
                                              new CoroutineHandle(Instance._instanceID), true);
        }
        ...
        {
            return coroutine == null ? new CoroutineHandle() :
                Instance.RunCoroutineInternal(coroutine, Segment.Update, layer, tag,
                                              new CoroutineHandle(Instance._instanceID), true);
        }
        ...
        {
            return coroutine == null ? new CoroutineHandle() :
                Instance.RunCoroutineInternal(coroutine, segment, null, null, new CoroutineHandle(Instance._instanceID),
                                              true);
        }
        ...
        {
            return coroutine == null ? new CoroutineHandle() :
                Instance.RunCoroutineInternal(coroutine, segment, layer, null,
                                              new CoroutineHandle(Instance._instanceID), true);
        }
        ...
        {
            return coroutine == null ? new CoroutineHandle() :
                Instance.RunCoroutineInternal(coroutine, segment, null, tag, new CoroutineHandle(Instance._instanceID),
                                              true);
        }
        ...
        {
            return coroutine == null ? new CoroutineHandle() :
                Instance.RunCoroutineInternal(coroutine, segment, layer, tag, new CoroutineHandle(Instance._instanceID),
                                              true);
        }
        ...
        public CoroutineHandle RunCoroutineOnInstance(IEnumerator<float> coroutine, GameObject gameObj)
        {
            return coroutine == null ? new CoroutineHandle() : RunCoroutineInternal(coroutine, Segment.Update,
                                                                                    gameObj == null ? (int?) null :
                                                                                        gameObj.GetInstanceID(), null,
                                                                                    new CoroutineHandle(_instanceID),
                                                                                    true);
        }
                                                            ...
                                                            SingletonBehavior behaviorOnCollision)
        {
            ...
            else if (IsRunning(handle))
            {
                ...
                {
                    CoroutineHandle newCoroutineHandle = Instance.RunCoroutineInternal(
                        coroutine, Segment.Update, null, null, new CoroutineHandle(Instance._instanceID), false);
                    WaitForOtherHandles(newCoroutineHandle, handle, false);
                    return newCoroutineHandle;
                }
            }

            return Instance.RunCoroutineInternal(coroutine, Segment.Update, null, null,
                                                 new CoroutineHandle(Instance._instanceID), true);
        }
        ...
        public static CoroutineHandle RunCoroutineSingleton(IEnumerator<float> coroutine, GameObject gameObj,
                                                            SingletonBehavior behaviorOnCollision)
        {
            return gameObj == null ? RunCoroutine(coroutine) :
                                                            ...
                                                            SingletonBehavior behaviorOnCollision)
        {
            ...
            else if (Instance._layeredProcesses.ContainsKey(layer))
            {
                ...
                {
                    CoroutineHandle newCoroutineHandle = Instance.RunCoroutineInternal(
                        coroutine, Segment.Update, layer, null, new CoroutineHandle(Instance._instanceID), false);
                    WaitForOtherHandles(newCoroutineHandle, _instance._layeredProcesses[layer], false);
                    return newCoroutineHandle;
                }
            }

            return Instance.RunCoroutineInternal(coroutine, Segment.Update, layer, null,
                                                 new CoroutineHandle(Instance._instanceID), true);
        }
                                                            ...
                                                            SingletonBehavior behaviorOnCollision)
        {
            ...
            else if (Instance._taggedProcesses.ContainsKey(tag))
            {
                ...
                {
                    CoroutineHandle newCoroutineHandle = Instance.RunCoroutineInternal(
                        coroutine, Segment.Update, null, tag, new CoroutineHandle(Instance._instanceID), false);
                    WaitForOtherHandles(newCoroutineHandle, _instance._taggedProcesses[tag], false);
                    return newCoroutineHandle;
                }
            }

            return Instance.RunCoroutineInternal(coroutine, Segment.Update, null, tag,
                                                 new CoroutineHandle(Instance._instanceID), true);
        }
                                                            ...
                                                            SingletonBehavior behaviorOnCollision)
        {
            ...
            if (behaviorOnCollision == SingletonBehavior.Overwrite)
            {
                ...
                return Instance.RunCoroutineInternal(coroutine, Segment.Update, layer, tag,
                                                     new CoroutineHandle(Instance._instanceID), true);
            }
            ...
            if (behaviorOnCollision == SingletonBehavior.Wait)
            {
                ...
                if (matches.Count > 0)
                {
                    CoroutineHandle newCoroutineHandle = _instance.RunCoroutineInternal(
                        coroutine, Segment.Update, layer, tag, new CoroutineHandle(_instance._instanceID), false);
        ...
        /// <returns>The newly created or existing handle.</returns>
        public static CoroutineHandle RunCoroutineSingleton(IEnumerator<float> coroutine, CoroutineHandle handle,
                                                            Segment segment, SingletonBehavior behaviorOnCollision)
        {
            if (coroutine == null) return new CoroutineHandle();
            ...
            return Instance.RunCoroutineInternal(coroutine, segment, null, null,
                                                 new CoroutineHandle(Instance._instanceID), true);
        }
        ...
        {
            return gameObj == null ? RunCoroutine(coroutine, segment) :
                                                            ...
                                                            SingletonBehavior behaviorOnCollision)
        {
            ...
            return Instance.RunCoroutineInternal(coroutine, segment, layer, null,
                                                 new CoroutineHandle(Instance._instanceID), true);
        }
                                                            ...
                                                            SingletonBehavior behaviorOnCollision)
        {
            ...
            return Instance.RunCoroutineInternal(coroutine, segment, null, tag,
                                                 new CoroutineHandle(Instance._instanceID), true);
        }
                                                            ...
                                                            string tag, SingletonBehavior behaviorOnCollision)
        {
            ...
            {
                KillCoroutines(layer, tag);
                return Instance.RunCoroutineInternal(coroutine, segment, layer, tag,
                                                     new CoroutineHandle(Instance._instanceID), true);
            }
                                                               ...
                                                               SingletonBehavior behaviorOnCollision)
        {
            ...
            else if (_handleToIndex.ContainsKey(handle) && !CoindexIsNull(_handleToIndex[handle]))
            {
                ...
                if (behaviorOnCollision == SingletonBehavior.Wait)
                {
                    CoroutineHandle newCoroutineHandle =
                        RunCoroutineInternal(coroutine, Segment.Update, null, null, new CoroutineHandle(_instanceID),
                                             false);
                    WaitForOtherHandles(newCoroutineHandle, handle, false);
                    return newCoroutineHandle;
                }
                                                               ...
                                                               SingletonBehavior behaviorOnCollision)
        {
            ...
            else if (_layeredProcesses.ContainsKey(layer))
            {
                ...
                {
                    CoroutineHandle newCoroutineHandle =
                        RunCoroutineInternal(coroutine, Segment.Update, layer, null, new CoroutineHandle(_instanceID),
                                             false);
                                                               ...
                                                               SingletonBehavior behaviorOnCollision)
        {
            ...
            else if (_taggedProcesses.ContainsKey(tag))
            {
                ...
                {
                    CoroutineHandle newCoroutineHandle =
                        RunCoroutineInternal(coroutine, Segment.Update, null, tag, new CoroutineHandle(_instanceID),
                                             false);
                                                               ...
                                                               SingletonBehavior behaviorOnCollision)
        {
            ...
            if (behaviorOnCollision == SingletonBehavior.Overwrite)
            {
                ...
                return RunCoroutineInternal(coroutine, Segment.Update, layer, tag, new CoroutineHandle(_instanceID),
                                            true);
            }
            ...
            if (behaviorOnCollision == SingletonBehavior.Wait)
            {
                ...
                {
                    CoroutineHandle newCoroutineHandle =
                        RunCoroutineInternal(coroutine, Segment.Update, layer, tag, new CoroutineHandle(_instanceID),
                                             false);
                    WaitForOtherHandles(newCoroutineHandle, matches, false);
                    return newCoroutineHandle;
                }
                                                               ...
                                                               SingletonBehavior behaviorOnCollision)
        {
            ...
            else if (_layeredProcesses.ContainsKey(layer))
            {
                ...
                {
                    CoroutineHandle newCoroutineHandle =
                        RunCoroutineInternal(coroutine, segment, layer, null, new CoroutineHandle(_instanceID), false);
                    WaitForOtherHandles(newCoroutineHandle, _layeredProcesses[layer], false);
                    return newCoroutineHandle;
                }
            }
                                                               ...
                                                               string tag, SingletonBehavior behaviorOnCollision)
        {
            ...
            else if (_taggedProcesses.ContainsKey(tag))
            {
                ...
                {
                    CoroutineHandle newCoroutineHandle =
                        RunCoroutineInternal(coroutine, segment, null, tag, new CoroutineHandle(_instanceID), false);
                    WaitForOtherHandles(newCoroutineHandle, _taggedProcesses[tag], false);
                    return newCoroutineHandle;
                }
            }
                                                               ...
                                                               string tag, SingletonBehavior behaviorOnCollision)
        {
            ...
            else if (behaviorOnCollision == SingletonBehavior.Wait)
            {
                ...
                {
                    CoroutineHandle newCoroutineHandle =
                        RunCoroutineInternal(coroutine, segment, layer, tag, new CoroutineHandle(_instanceID), false);
                    WaitForOtherHandles(newCoroutineHandle, matches, false);
                    return newCoroutineHandle;
                }
            }
        ...
        private CoroutineHandle RunCoroutineInternal(IEnumerator<float> coroutine, Segment segment, int? layer,
                                                     string tag, CoroutineHandle handle, bool prewarm)
        {
                ...
                switch (segment)
                {
                                     ...
                                     float.IsNaN(FixedUpdateProcesses[slot.i].Current))
                            {
                                if (ReplacementFunction != null)
                                {
                                    FixedUpdateProcesses[slot.i] =
                                        ReplacementFunction(FixedUpdateProcesses[slot.i], _indexToHandle[slot]);
                                    ReplacementFunction = null;
                                }
                    ...
                    case Segment.RealtimeUpdate:
                        ...
                        if (_nextRealtimeUpdateProcessSlot >= RealtimeUpdateProcesses.Length)
                        {
                            ...
                            RealtimeUpdateProcesses =
                                new IEnumerator<float>[RealtimeUpdateProcesses.Length +
                                                       (ProcessArrayChunkSize * _expansions++)];
                    ...
                    case Segment.EditorUpdate:
                        ...
                        if (_nextEditorUpdateProcessSlot >= EditorUpdateProcesses.Length)
                        {
                            ...
                            EditorUpdateProcesses =
                                new IEnumerator<float>[EditorUpdateProcesses.Length +
                                                       (ProcessArrayChunkSize * _expansions++)];
                        ...
                        while (prewarm)
                        {
                                     ...
                                     float.IsNaN(EditorUpdateProcesses[slot.i].Current))
                            {
                                if (ReplacementFunction != null)
                                {
                                    EditorUpdateProcesses[slot.i] =
                                        ReplacementFunction(EditorUpdateProcesses[slot.i], _indexToHandle[slot]);
                                    ReplacementFunction = null;
                                }
                    ...
                    case Segment.EditorSlowUpdate:
                        ...
                        if (_nextEditorSlowUpdateProcessSlot >= EditorSlowUpdateProcesses.Length)
                        {
                            ...
                            EditorSlowUpdateProcesses =
                                new IEnumerator<float>[EditorSlowUpdateProcesses.Length +
                                                       (ProcessArrayChunkSize * _expansions++)];
                    ...
                    case Segment.EndOfFrame:
                        ...
                        _eofWatcherHandle =
                            RunCoroutineSingletonOnInstance(_EOFPumpWatcher(), _eofWatcherHandle,
                    ...
                    case Segment.ManualTimeframe:
                        ...
                        if (_nextManualTimeframeProcessSlot >= ManualTimeframeProcesses.Length)
                        {
                            ...
                            ManualTimeframeProcesses =
                                new IEnumerator<float>[ManualTimeframeProcesses.Length +
                                                       (ProcessArrayChunkSize * _expansions++)];
        ...
        public int KillCoroutinesOnInstance()
        {
            int retVal = _nextUpdateProcessSlot + _nextLateUpdateProcessSlot + _nextFixedUpdateProcessSlot +
                         ...
                         _nextEditorSlowUpdateProcessSlot + _nextEndOfFrameProcessSlot +
                         _nextManualTimeframeProcessSlot;
        ...
        public int KillCoroutinesOnInstance(int layer, string tag)
        {
            ...
            while (indexesEnum.MoveNext())
            {
                if (CoindexIsNull(_handleToIndex[indexesEnum.Current]) ||
                    !_layeredProcesses[layer].Contains(indexesEnum.Current) || !Nullify(indexesEnum.Current))
                    continue;
        ...
        private bool UpdateTimeValues(Segment segment)
        {
            switch (segment)
            {
                ...
                case Segment.ManualTimeframe:
                    float timeCalculated = SetManualTimeframeTime == null ? Time.time :
                ...
                if (!RealtimeUpdatePaused[i] && RealtimeUpdateProcesses[i] != null)
                {
                    ...
                    if (RealtimeUpdateProcesses[i].Current > GetSegmentTime(Segment.RealtimeUpdate))
                        RealtimeUpdateProcesses[i] = _InjectDelay(RealtimeUpdateProcesses[i],
                                                                  RealtimeUpdateProcesses[i].Current -
                                                                  GetSegmentTime(Segment.RealtimeUpdate));
                }
            }
                ...
                if (!EditorUpdatePaused[i] && EditorUpdateProcesses[i] != null)
                {
                    ...
                    if (EditorUpdateProcesses[i].Current > GetSegmentTime(Segment.EditorUpdate))
                        EditorUpdateProcesses[i] = _InjectDelay(EditorUpdateProcesses[i],
                                                                EditorUpdateProcesses[i].Current -
                                                                GetSegmentTime(Segment.EditorUpdate));
                }
            }
                ...
                if (!EditorSlowUpdatePaused[i] && EditorSlowUpdateProcesses[i] != null)
                {
                    ...
                    if (EditorSlowUpdateProcesses[i].Current > GetSegmentTime(Segment.EditorSlowUpdate))
                        EditorSlowUpdateProcesses[i] = _InjectDelay(EditorSlowUpdateProcesses[i],
                                                                    EditorSlowUpdateProcesses[i].Current -
                                                                    GetSegmentTime(Segment.EditorSlowUpdate));
                }
            }
                ...
                if (!EndOfFramePaused[i] && EndOfFrameProcesses[i] != null)
                {
                    ...
                    if (EndOfFrameProcesses[i].Current > GetSegmentTime(Segment.EndOfFrame))
                        EndOfFrameProcesses[i] = _InjectDelay(EndOfFrameProcesses[i],
                                                              EndOfFrameProcesses[i].Current -
                                                              GetSegmentTime(Segment.EndOfFrame));
                }
            }
                ...
                if (!ManualTimeframePaused[i] && ManualTimeframeProcesses[i] != null)
                {
                    ...
                    if (ManualTimeframeProcesses[i].Current > GetSegmentTime(Segment.ManualTimeframe))
                        ManualTimeframeProcesses[i] = _InjectDelay(ManualTimeframeProcesses[i],
                                                                   ManualTimeframeProcesses[i].Current -
                                                                   GetSegmentTime(Segment.ManualTimeframe));
                }
            }
        ...
        public int ResumeCoroutinesOnInstance()
        {
            ...
            for (coindex.i = 0, coindex.seg = Segment.RealtimeUpdate; coindex.i < _nextRealtimeUpdateProcessSlot;
                 coindex.i++)
            {
            ...
            for (coindex.i = 0, coindex.seg = Segment.EditorUpdate; coindex.i < _nextEditorUpdateProcessSlot;
                 coindex.i++)
            {
            ...
            for (coindex.i = 0, coindex.seg = Segment.EditorSlowUpdate; coindex.i < _nextEditorSlowUpdateProcessSlot;
                 coindex.i++)
            {
            ...
            for (coindex.i = 0, coindex.seg = Segment.ManualTimeframe; coindex.i < _nextManualTimeframeProcessSlot;
                 coindex.i++)
            {
        ...
        {
            TimeTunnel inst = GetInstance(handle.Key);
        ...
        {
            TimeTunnel inst = GetInstance(handle.Key);
            return inst != null && inst._handleToIndex.ContainsKey(handle) ? inst._handleToIndex[handle].seg :
                Segment.Invalid;
        }
        ...
        public static bool SetSegment(CoroutineHandle handle, Segment newSegment)
        {
            ...
            inst.RunCoroutineInternal(inst.CoindexExtract(inst._handleToIndex[handle]), newSegment,
                                      inst._processLayers.ContainsKey(handle) ? inst._processLayers[handle] :
                                          (int?) null,
                                      inst._processTags.ContainsKey(handle) ? inst._processTags[handle] : null, handle,
                                      false);
                ...
                case Segment.Update:
                    ...
                    if (newPausedState && UpdateProcesses[coindex.i].Current > GetSegmentTime(coindex.seg))
                        UpdateProcesses[coindex.i] = _InjectDelay(UpdateProcesses[coindex.i],
                                                                  UpdateProcesses[coindex.i].Current -
                ...
                case Segment.RealtimeUpdate:
                    ...
                    if (newPausedState && RealtimeUpdateProcesses[coindex.i].Current > GetSegmentTime(coindex.seg))
                        RealtimeUpdateProcesses[coindex.i] = _InjectDelay(RealtimeUpdateProcesses[coindex.i],
                                                                          RealtimeUpdateProcesses[coindex.i].Current -
                                                                          GetSegmentTime(coindex.seg));
                ...
                case Segment.EditorUpdate:
                    ...
                    if (newPausedState && EditorUpdateProcesses[coindex.i].Current > GetSegmentTime(coindex.seg))
                        EditorUpdateProcesses[coindex.i] = _InjectDelay(EditorUpdateProcesses[coindex.i],
                                                                        EditorUpdateProcesses[coindex.i].Current -
                                                                        GetSegmentTime(coindex.seg));
                ...
                case Segment.EditorSlowUpdate:
                    ...
                    if (newPausedState && EditorSlowUpdateProcesses[coindex.i].Current > GetSegmentTime(coindex.seg))
                        EditorSlowUpdateProcesses[coindex.i] = _InjectDelay(EditorSlowUpdateProcesses[coindex.i],
                                                                            EditorSlowUpdateProcesses[coindex.i]
                                                                                .Current - GetSegmentTime(coindex.seg));
                ...
                case Segment.EndOfFrame:
                    ...
                    if (newPausedState && EndOfFrameProcesses[coindex.i].Current > GetSegmentTime(coindex.seg))
                        EndOfFrameProcesses[coindex.i] = _InjectDelay(EndOfFrameProcesses[coindex.i],
                                                                      EndOfFrameProcesses[coindex.i].Current -
                                                                      GetSegmentTime(coindex.seg));
                ...
                case Segment.ManualTimeframe:
                    ...
                    if (newPausedState && ManualTimeframeProcesses[coindex.i].Current > GetSegmentTime(coindex.seg))
                        ManualTimeframeProcesses[coindex.i] = _InjectDelay(ManualTimeframeProcesses[coindex.i],
                                                                           ManualTimeframeProcesses[coindex.i].Current -
                                                                           GetSegmentTime(coindex.seg));
                ...
                case Segment.EditorSlowUpdate:
                    ...
                    if (EditorSlowUpdateProcesses[coindex.i].Current > GetSegmentTime(coindex.seg))
                        coptr = _InjectDelay(EditorSlowUpdateProcesses[coindex.i],
                                             EditorSlowUpdateProcesses[coindex.i].Current -
                                             GetSegmentTime(coindex.seg));
        ...
        {
            TimeTunnel inst = GetInstance(otherCoroutine.Key);
                                               ...
                                               bool warnOnIssue = true)
        {
            ...
            if (inst != null && inst._handleToIndex.ContainsKey(handle) &&
                inst._handleToIndex.ContainsKey(otherHandle) && !inst.CoindexIsNull(inst._handleToIndex[otherHandle]))
            {
                if (!inst._waitingTriggers.ContainsKey(otherHandle))
                {
                    inst.CoindexReplace(inst._handleToIndex[otherHandle],
                                        inst._StartWhenDone(otherHandle,
                                                            inst.CoindexPeek(inst._handleToIndex[otherHandle])));
        ...
        public static float WaitUntilDone(AsyncOperation operation)
        {
            ...
            TimeTunnel inst = GetInstance(CurrentCoroutine.Key);
        ...
        private static IEnumerator<float> _StartWhenDone(System.Func<bool> evaluatorFunc, bool continueOn,
                                                         IEnumerator<float> pausedProc)
        {
        ...
        {
            TimeTunnel instance = GetInstance(handle.Key);
            instance.RunCoroutineInternal(coptr, _tmpSegment,
                                          instance._processLayers.ContainsKey(handle) ?
                                              instance._processLayers[handle] : (int?) null,
                                          instance._processTags.ContainsKey(handle) ? instance._processTags[handle] :
                                              null, handle, false);
            return null;
        }
        ...
        private static IEnumerator<float> SwitchCoroutineRepST(IEnumerator<float> coptr, CoroutineHandle handle)
        {
            ...
            instance.RunCoroutineInternal(coptr, _tmpSegment,
                                          instance._processLayers.ContainsKey(handle) ?
                                              instance._processLayers[handle] : (int?) null, _tmpRef as string, handle,
                                          false);
            return null;
        }
                                                       ...
                                                       GameObject gameObject, System.Action onDone = null)
        {
            ...
            if (!float.IsPositiveInfinity(timeframe))
                LinkCoroutines(
                    handle, RunCoroutine(Instance._WatchCall(timeframe, handle, gameObject, onDone), gameObject));
            return handle;
        }
                                                          ...
                                                          GameObject gameObject, System.Action onDone = null)
        {
            ...
            if (!float.IsPositiveInfinity(timeframe))
                LinkCoroutines(
                    handle, RunCoroutineOnInstance(_WatchCall(timeframe, handle, gameObject, onDone), gameObject));
            return handle;
        }
        ...
        /// <returns>The handle to the coroutine that is started by this function.</returns>
        public static CoroutineHandle CallPeriodically(float timeframe, float period, System.Action action,
                                                       Segment timing, GameObject gameObject,
                                                       System.Action onDone = null)
        {
            CoroutineHandle handle = action == null ? new CoroutineHandle() :
        ...
        /// <param name="onDone">An optional action to call when this function finishes.</param>
        /// <returns>The handle to the coroutine that is started by this function.</returns>
        public static CoroutineHandle CallContinuously(float timeframe, System.Action action,
                                                       System.Action onDone = null)
        {
            CoroutineHandle handle = action == null ? new CoroutineHandle() :
        ...
        /// <param name="onDone">An optional action to call when this function finishes.</param>
        /// <returns>The handle to the coroutine that is started by this function.</returns>
        public CoroutineHandle CallContinuouslyOnInstance(float timeframe, System.Action action,
                                                          System.Action onDone = null)
        {
            CoroutineHandle handle = action == null ? new CoroutineHandle() :
        ...
        /// <param name="onDone">An optional action to call when this function finishes.</param>
        /// <returns>The handle to the coroutine that is started by this function.</returns>
        public static CoroutineHandle CallContinuously(float timeframe, System.Action action, GameObject gameObject,
                                                       System.Action onDone = null)
        {
            CoroutineHandle handle = action == null ? new CoroutineHandle() :
        ...
        /// <param name="onDone">An optional action to call when this function finishes.</param>
        /// <returns>The handle to the coroutine that is started by this function.</returns>
        public CoroutineHandle CallContinuouslyOnInstance(float timeframe, System.Action action, GameObject gameObject,
                                                          System.Action onDone = null)
        {
            CoroutineHandle handle = action == null ? new CoroutineHandle() :
        ...
        /// <returns>The handle to the coroutine that is started by this function.</returns>
        public static CoroutineHandle CallPeriodically<T>(T reference, float timeframe, float period,
                                                          System.Action<T> action, GameObject gameObject,
        ...
        /// <returns>The handle to the coroutine that is started by this function.</returns>
        public static CoroutineHandle CallPeriodically<T>(T reference, float timeframe, float period,
                                                          System.Action<T> action, Segment timing,
                                                          System.Action<T> onDone = null)
        {
            CoroutineHandle handle = action == null ? new CoroutineHandle() :
            ...
            if (!float.IsPositiveInfinity(timeframe))
                LinkCoroutines(
                    handle, RunCoroutine(Instance._WatchCall(reference, timeframe, handle, null, onDone), timing));
            return handle;
        }
                                                             ...
                                                             System.Action<T> onDone = null)
        {
            ...
            if (!float.IsPositiveInfinity(timeframe))
                LinkCoroutines(
                    handle, RunCoroutineOnInstance(_WatchCall(reference, timeframe, handle, null, onDone), timing));
            return handle;
        }
        ...
        private IEnumerator<float> _WatchCall<T>(T reference, float timeframe, CoroutineHandle handle,
                                                 GameObject gObject, System.Action<T> onDone)
        {
            yield return WaitForSecondsOnInstance(timeframe);
        ...
        private IEnumerator<float> _CallContinuously<T>(T reference, float period, System.Action<T> action,
                                                        GameObject gObject)
        {
            while ((ReferenceEquals(gObject, null) || gObject != null))
            {
    ...
    public struct CoroutineHandle : System.IEquatable<CoroutineHandle>
    {
        ...
        public override string ToString()
        {
            ...
            else
            {
                if (TimeTunnel.GetLayer(this) == null)
                    ...
                    return TimeTunnel.GetDebugName(this) + " Tag: " + TimeTunnel.GetTag(this) + " Layer: " +
                           TimeTunnel.GetLayer(this);
            }
        }
        ...
        public string Tag
        {
            get { return TimeTunnel.GetTag(this); }
        ...
        public int? Layer
        {
            get { return TimeTunnel.GetLayer(this); }
            set
            {
                if (value == null)
        ...
        {
            get { return TimeTunnel.GetSegment(this); }
        ...
        {
            get { return TimeTunnel.IsRunning(this); }
            set
            {
                if (!value) TimeTunnel.KillCoroutines(this);
            }
        }
        ...
        {
            get { return TimeTunnel.IsPaused(this); }
            set
            {
                if (value) TimeTunnel.PauseCoroutines(this);
                else TimeTunnel.ResumeCoroutines(this);
            }
        }
        ...
        {
            get { return TimeTunnel.IsAliveAndPaused(this); }
            set
            {
                if (value) TimeTunnel.PauseCoroutines(this);
                else TimeTunnel.ResumeCoroutines(this);
    ...
    public static class MECExtensionMethods
    {
        ...
        /// <param name="condition">The coroutine will be paused until this function returns true.</param>
        /// <returns>The modified coroutine handle.</returns>
        public static IEnumerator<float> Delay<T>(this IEnumerator<float> coroutine, T data,
        ...
        {
            while (TimeTunnel.MainThread != System.Threading.Thread.CurrentThread ||
                   (gameObject1 && gameObject1.activeInHierarchy && gameObject2 && gameObject2.activeInHierarchy &&
                    coroutine.MoveNext()))
                yield return coroutine.Current;
        }
            ...
            where T : MonoBehaviour
        {
            ...
            while (TimeTunnel.MainThread == System.Threading.Thread.CurrentThread && myGO &&
                   myGO.GetComponent<T>() != null)
            {
